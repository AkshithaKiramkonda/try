...
with tab1:
    ...
    st.image("C:/Users/HP/OneDrive/Pictures/hid2.jpg",width=400)
with tab2:
    st.subheader("Traditional")
    st.image("C:/Users/HP/OneDrive/Pictures/hid1.jpg",width =400)
...
with st.expander("R u ready!!"):
    tab1,tab2=st.tabs(["",""])
    with tab1:
        st.video("C:/Users/HP/Videos/hid3.mp4")
    with tab2:
        st.write("")
    st.write(""""
...
st.audio("C:/Users/HP/Music/mine.unknown")
